...
public class QueenProblem {
	...
	public static void main(String[] args) {
		QueenProblemSol sol = new QueenProblemSol();
		sol.execute();
	}
}

class QueenProblemSol {
	...
	private boolean isValidMatrix(int[][] array, int row, int col) {
		return isHorizontallyValid(array, row, col) && isVerticallyValid(array, row, col)
				&& isTopLeftValid(array, row, col) && isTopRightValid(array, row, col);
	}
