...
public class FbMinWeightPath {
	...
	private static final List<FbPoint> eightAllowedMoves = Collections.unmodifiableList(Arrays.asList(new FbPoint(0, 1), new FbPoint(1, 1), new FbPoint(1, 0), new FbPoint(1, -1),
			new FbPoint(0, -1), new FbPoint(-1, -1), new FbPoint(-1, 0), new FbPoint(-1, 1)));
	 ...
	 * 2. Satisfy this condition (adjCellValue + inputMatCellValue == traMatCellValue)
	 * And keep adding it to list 
	 * @param input
	...
	/**
	 * Traverse the matrix and return cell coordinate which is un-traversed and has smallest value
	 * @param traversalMatrix
	 * @return
	 */
