...
public class TrapRainWater {
    ...
    public void execute() {
       ...
       int[][] heightMap2 = { {12,13,0,12}, {13,4,13,12}, {13,8,10,12}, {12,13,12,12}, {13,13,13,13}};
       int[][] heightMap3 = { {12,13,0,12}, {13,4,13,12}, {13,8,10,12}, {12,13,12,12}, {13,13,13,13}};
       
       assertEquals(4, trapRainWater(heightMap1));
       assertEquals(14, trapRainWater(heightMap2));
    }
    ...
    private int traverseAdjacentCells(int[][] heightMap, Set<Cell> traversed, int max, Cell c, Queue<Cell> pq) {
        ...
        int cap = 0;
        List<Cell> adjacent = Arrays.asList(new Cell(1,0), new Cell(-1, 0), new Cell(0,1), new Cell(0, -1));
