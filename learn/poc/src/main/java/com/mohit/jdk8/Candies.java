...
public class Candies {
	...
	public static void main(String[] args) {
		...
		int r = maxCandies(new int[] { 1, 0, 1, 0 }, new int[] { 7, 5, 4, 100 }, new int[][] { {}, {}, { 1 }, {} },
	...
	public static void collectBoxesAndKeys(Set<Integer> cBoxes, Set<Integer> cKeys, int[][] keys, int[][] boxes,
			int[] initBoxes) {
